...
#define mlk_mlk_keccak_absorb_once_x4 MLK_NAMESPACE(keccak_absorb_once_x4)
#define mlk_mlk_keccak_squeezeblocks_x4 MLK_NAMESPACE(keccak_squeezeblocks_x4)
...
static void mlk_mlk_keccak_absorb_once_x4(
    uint64_t *s, uint32_t r, const uint8_t *in0, const uint8_t *in1,
...
static void mlk_mlk_keccak_squeezeblocks_x4(uint8_t *out0, uint8_t *out1,
                                ...
                                const uint8_t *in3, size_t inlen)
{
  ...
  mlk_mlk_keccak_absorb_once_x4(state->ctx, SHAKE128_RATE, in0, in1, in2, in3,
                                inlen, 0x1F);
}
...
{
  mlk_mlk_keccak_squeezeblocks_x4(out0, out1, out2, out3, nblocks, state->ctx,
                                  SHAKE128_RATE);
}
...
{
  memset(state, 0, sizeof(mlk_shake128x4ctx));
  mlk_mlk_keccak_absorb_once_x4(state->ctx, SHAKE256_RATE, in0, in1, in2, in3,
                                inlen, 0x1F);
}
...
#undef mlk_mlk_keccak_absorb_once_x4
#undef mlk_mlk_keccak_squeezeblocks_x4
