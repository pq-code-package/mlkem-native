 ...
 *
 *              Bounds:
 *              - Every coefficient of @p a is assumed to be in [0..4095]
 *              - Every coefficient of @p b is assumed to be bound by
 *                MLK_NTT_BOUND in absolute value.
 *              - Every coefficient of @p b_cache is assumed to be bound by
 *                MLKEM_Q in absolute value.
