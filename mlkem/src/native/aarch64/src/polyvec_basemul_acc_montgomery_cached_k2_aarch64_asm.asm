 ...
 *   mlkem/src/native/aarch64/src/polyvec_basemul_acc_montgomery_cached_k2_aarch64_asm.S using scripts/simpasm --translate-armasm. Do not modify it directly.
 */
/*
 ...
 */
        ...
        EXPORT MLK_ASM_NAMESPACE(polyvec_basemul_acc_montgomery_cached_k2_aarch64_asm)
