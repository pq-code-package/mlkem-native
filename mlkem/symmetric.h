...
#define hash_h(OUT, IN, INBYTES) mlk_sha3_256(OUT, IN, INBYTES)

/* Hash function G, [FIPS 203, Section 4.1, Eq (4.5)] */
#define hash_g(OUT, IN, INBYTES) mlk_sha3_512(OUT, IN, INBYTES)

/* Hash function J, [FIPS 203, Section 4.1, Eq (4.4)] */
#define hash_j(OUT, IN, INBYTES) mlk_shake256(OUT, MLKEM_SYMBYTES, IN, INBYTES)
...
#define xof_ctx mlk_shake128ctx
#define xof_x4_ctx mlk_shake128x4ctx
#define xof_init(CTX) mlk_shake128_init((CTX))
...
#define xof_release(CTX) mlk_shake128_release((CTX))

#define xof_x4_init(CTX) mlk_shake128x4_init((CTX))
...
#define xof_x4_release(CTX) mlk_shake128x4_release((CTX))
