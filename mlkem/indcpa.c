...
#define mlk_pack_pk MLK_NAMESPACE_K(pack_pk)
#define mlk_unpack_pk MLK_NAMESPACE_K(unpack_pk)
#define mlk_pack_sk MLK_NAMESPACE_K(pack_sk)
#define mlk_unpack_sk MLK_NAMESPACE_K(unpack_sk)
#define mlk_pack_ciphertext MLK_NAMESPACE_K(pack_ciphertext)
#define mlk_unpack_ciphertext MLK_NAMESPACE_K(unpack_ciphertext)
#define mlk_matvec_mul MLK_NAMESPACE_K(matvec_mul)
...
{
  mlk_debug_assert_bound_2d(pk, MLKEM_K, MLKEM_N, 0, MLKEM_Q);
...
{
  mlk_debug_assert_bound_2d(sk, MLKEM_K, MLKEM_N, 0, MLKEM_Q);
                    ...
                    int transposed)
{
  ...
  mlk_debug_assert(i == MLKEM_K * MLKEM_K);
