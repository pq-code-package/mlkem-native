...
#define mlk_ntt_layer MLK_NAMESPACE(ntt_layer)
#define mlk_invntt_layer MLK_NAMESPACE(invntt_layer)
...
#undef mlk_fqmul
#undef mlk_barrett_reduce
#undef mlk_scalar_signed_to_unsigned_q
#undef mlk_ntt_butterfly_block
#undef mlk_ntt_layer
