...
#ifndef MLKEM_NATIVE_NATIVE_AARCH64_SRC_OPT_IMPL_H
#define MLKEM_NATIVE_NATIVE_AARCH64_SRC_OPT_IMPL_H
...
static INLINE void polyvec_basemul_acc_montgomery_cached_k3_native(
    ...
    const int16_t b[3 * MLKEM_N],
    const int16_t b_cache[3 * (MLKEM_N / 2)])
{
...
static INLINE void polyvec_basemul_acc_montgomery_cached_k4_native(
    ...
    const int16_t b[4 * MLKEM_N],
    const int16_t b_cache[4 * (MLKEM_N / 2)])
{
...
#endif /* MLKEM_NATIVE_NATIVE_AARCH64_SRC_OPT_IMPL_H */
