...
#define SELFTEST_RUN_ARCH(arch_label, state_t, init_fn, stub_fn, check_fn, \
  ...
  {                                                                        \
    ...
    {                                                                      \
      ...
      violations =                                                         \
          check_fn(&input_state, &output_state, MLK_ABICHECK_QUIET);       \
...
extern MLK_SYSV_ABI void selftest_x86_64_noop(void);
extern MLK_SYSV_ABI void selftest_x86_64_corrupt_rbx(void);
extern MLK_SYSV_ABI void selftest_x86_64_corrupt_rbp(void);
extern MLK_SYSV_ABI void selftest_x86_64_corrupt_r12(void);
extern MLK_SYSV_ABI void selftest_x86_64_corrupt_r13(void);
extern MLK_SYSV_ABI void selftest_x86_64_corrupt_r14(void);
extern MLK_SYSV_ABI void selftest_x86_64_corrupt_r15(void);
...
int abicheck_selftest(void)
{
  ...
  SELFTEST_RUN_ARCH("aarch64", struct aarch64_register_state,
                    ...
                    /* fn_cast */);
#elif defined(MLK_SYS_X86_64) && defined(MLK_SYSV_ABI_SUPPORTED)
  SELFTEST_RUN_ARCH("x86_64", struct x86_64_register_state,
                    init_x86_64_register_state, asm_call_stub_x86_64_sysv,
                    check_x86_64_sysv_compliance, x86_64_entries,
                    (MLK_SYSV_ABI void (*)(void)));
#elif defined(MLK_SYS_PPC64LE)
