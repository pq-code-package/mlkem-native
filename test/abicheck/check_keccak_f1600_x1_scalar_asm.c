...
int check_keccak_f1600_x1_scalar_asm(void)
{
  ...
  for (test_iter = 0; test_iter < NUM_TESTS; test_iter++)
  {
    ...
    aarch64_call_stub(&input_state, &output_state,
                      (void (*)(void))mlk_keccak_f1600_x1_scalar_asm);
    ...
    {
      fprintf(stderr,
              "ABI test FAILED for keccak_f1600_x1_scalar_asm (iteration %d): "
              "%d violations\n",
...
#include "../../mlkem/src/common.h"
MLK_EMPTY_CU(check_keccak_f1600_x1_scalar_asm)
