...
__attribute__((aligned(32), used, section(".stdout_capture"))) volatile uint8_t
    nucleo_stdout_capture[NUCLEO_STDOUT_CAPTURE_SIZE];
...
#endif /* NUCLEO_USE_SEMIHOSTING_WRITE */
