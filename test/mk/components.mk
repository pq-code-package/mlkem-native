...
ABICHECK_SOURCES = test/abicheck/abicheck.c test/abicheck/abicheckutil.c test/abicheck/selftest.c
ABICHECK_SOURCES += $(wildcard test/abicheck/$(ABICHECK_ARCH)/$(ABICHECK_ARCH)_callstub.S)
ABICHECK_SOURCES += $(wildcard test/abicheck/$(ABICHECK_ARCH)/selftest_$(ABICHECK_ARCH).S)
ABICHECK_SOURCES += $(wildcard test/abicheck/$(ABICHECK_ARCH)/check_*.c)
...
# YAML 'ABI.Features:' list.
include test/abicheck/abicheck_features.mk
...
# AVX2-not-assemblable case: drop AVX2 kernels if the compiler lacks either
# -mavx2 or -mbmi2 (mirrors the auto.mk gate at $(MK_COMPILER_SUPPORTS_*)).
ifeq ($(ARCH),x86_64)
ifneq ($(MK_COMPILER_SUPPORTS_AVX2)$(MK_COMPILER_SUPPORTS_BMI2),11)
ABICHECK_ASM_SOURCES := $(filter-out $(ABICHECK_REQ_AVX2_FILES),$(ABICHECK_ASM_SOURCES))
endif
endif
