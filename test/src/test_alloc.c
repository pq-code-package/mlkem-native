 ...
 * based on MLK_CONFIG_PARAMETER_SET.
 *
...
#define MLK_TOTAL_ALLOC_KEYPAIR \
  MLK_TOTAL_ALLOC_KEYPAIR_(MLK_CONFIG_PARAMETER_SET)
...
#define MLK_TOTAL_ALLOC_ENCAPS MLK_TOTAL_ALLOC_ENCAPS_(MLK_CONFIG_PARAMETER_SET)
...
#define MLK_TOTAL_ALLOC_DECAPS MLK_TOTAL_ALLOC_DECAPS_(MLK_CONFIG_PARAMETER_SET)

#define MLK_TOTAL_ALLOC__(LVL) MLK_TOTAL_ALLOC_##LVL
#define MLK_TOTAL_ALLOC_(LVL) MLK_TOTAL_ALLOC__(LVL)
#define MLK_TOTAL_ALLOC MLK_TOTAL_ALLOC_(MLK_CONFIG_PARAMETER_SET)
