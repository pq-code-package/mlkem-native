...
#define mve_keccak_state_permute_4fold_opt_m55 \
  MLK_NAMESPACE(mve_keccak_state_permute_4fold_opt_m55)
...
#define to_bit_interleaving_4x MLK_NAMESPACE(to_bit_interleaving_4x)
extern uint32x4x2_t to_bit_interleaving_4x(uint32x4_t, uint32x4_t);
#define from_bit_interleaving_4x MLK_NAMESPACE(from_bit_interleaving_4x)
extern uint32x4x2_t from_bit_interleaving_4x(uint32x4_t, uint32x4_t);
#define KeccakF1600x4_LoadBytesInLane \
  MLK_NAMESPACE(KeccakF1600x4_LoadBytesInLane)
uint32x4x2_t KeccakF1600x4_LoadBytesInLane(uint32x4_t data_ptrs,
                                           uint32_t length, uint32_t offset);
#define KeccakF1600x4_StateXORBytes_aligned \
  MLK_NAMESPACE(KeccakF1600x4_StateXORBytes_aligned)
...
#undef mve_keccak_state_permute_4fold_opt_m55
#undef to_bit_interleaving_4x
#undef from_bit_interleaving_4x
#undef KeccakF1600x4_LoadBytesInLane
#undef KeccakF1600x4_StateXORBytes_aligned
