...
run_kat_512: kat_512
	$(W) $(MLKEM512_DIR)/bin/gen_KAT512 | python3 test/src/kat_client.py --scheme 512
run_kat_768: kat_768
	$(W) $(MLKEM768_DIR)/bin/gen_KAT768 | python3 test/src/kat_client.py --scheme 768
run_kat_1024: kat_1024
	$(W) $(MLKEM1024_DIR)/bin/gen_KAT1024 | python3 test/src/kat_client.py --scheme 1024
