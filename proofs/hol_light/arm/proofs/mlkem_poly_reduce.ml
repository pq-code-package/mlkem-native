...
[
  ...
  0x3dc00c05;       (* arm_LDR Q5 X0 (Immediate_Offset (word 48)) *)
  0x4f44c016;       (* arm_SQDMULH_VEC Q22 Q0 (Q4 :> LANE_H 0) 16 128 *)
  0x4f44c23d;       (* arm_SQDMULH_VEC Q29 Q17 (Q4 :> LANE_H 0) 16 128 *)
  0x4f44c350;       (* arm_SQDMULH_VEC Q16 Q26 (Q4 :> LANE_H 0) 16 128 *)
  0x4f1526d6;       (* arm_SRSHR_VEC Q22 Q22 11 16 128 *)
  0x4f44c242;       (* arm_SQDMULH_VEC Q2 Q18 (Q4 :> LANE_H 0) 16 128 *)
  0x4f1527b9;       (* arm_SRSHR_VEC Q25 Q29 11 16 128 *)
  0x6f4342c0;       (* arm_MLS_VEC Q0 Q22 (Q3 :> LANE_H 0) 16 128 *)
  0x4f152610;       (* arm_SRSHR_VEC Q16 Q16 11 16 128 *)
  0x6f434331;       (* arm_MLS_VEC Q17 Q25 (Q3 :> LANE_H 0) 16 128 *)
  0x4f15245b;       (* arm_SRSHR_VEC Q27 Q2 11 16 128 *)
  0x6f43421a;       (* arm_MLS_VEC Q26 Q16 (Q3 :> LANE_H 0) 16 128 *)
  0x4f11041c;       (* arm_SSHR_VEC Q28 Q0 15 16 128 *)
  0x6f434372;       (* arm_MLS_VEC Q18 Q27 (Q3 :> LANE_H 0) 16 128 *)
  0x4f110630;       (* arm_SSHR_VEC Q16 Q17 15 16 128 *)
  0x4e3c1c74;       (* arm_AND_VEC Q20 Q3 Q28 128 *)
  0x4e301c76;       (* arm_AND_VEC Q22 Q3 Q16 128 *)
  0x4f11075c;       (* arm_SSHR_VEC Q28 Q26 15 16 128 *)
  0x4e748410;       (* arm_ADD_VEC Q16 Q0 Q20 16 128 *)
  0x4e768639;       (* arm_ADD_VEC Q25 Q17 Q22 16 128 *)
  0x4e3c1c7b;       (* arm_AND_VEC Q27 Q3 Q28 128 *)
  0xd1000821;       (* arm_SUB X1 X1 (rvalue (word 2)) *)
  0x3dc00400;       (* arm_LDR Q0 X0 (Immediate_Offset (word 16)) *)
  0x4f110655;       (* arm_SSHR_VEC Q21 Q18 15 16 128 *)
  0x4e7b8751;       (* arm_ADD_VEC Q17 Q26 Q27 16 128 *)
  0x3cc4041a;       (* arm_LDR Q26 X0 (Postimmediate_Offset (word 64)) *)
  0x4e351c75;       (* arm_AND_VEC Q21 Q3 Q21 128 *)
  ...
  0x3c990019;       (* arm_STR Q25 X0 (Immediate_Offset (word 18446744073709551504)) *)
  0x4f44c0b9;       (* arm_SQDMULH_VEC Q25 Q5 (Q4 :> LANE_H 0) 16 128 *)
  0x4e7b8751;       (* arm_ADD_VEC Q17 Q26 Q27 16 128 *)
  0x3cde001b;       (* arm_LDR Q27 X0 (Immediate_Offset (word 18446744073709551584)) *)
  0x3c9b0010;       (* arm_STR Q16 X0 (Immediate_Offset (word 18446744073709551536)) *)
  0x3c980011;       (* arm_STR Q17 X0 (Immediate_Offset (word 18446744073709551488)) *)
  0x4f44c01f;       (* arm_SQDMULH_VEC Q31 Q0 (Q4 :> LANE_H 0) 16 128 *)
  0x4f152727;       (* arm_SRSHR_VEC Q7 Q25 11 16 128 *)
  0x4f44c379;       (* arm_SQDMULH_VEC Q25 Q27 (Q4 :> LANE_H 0) 16 128 *)
  0x4f44c3a6;       (* arm_SQDMULH_VEC Q6 Q29 (Q4 :> LANE_H 0) 16 128 *)
  0x4f1527f5;       (* arm_SRSHR_VEC Q21 Q31 11 16 128 *)
  0x6f4340e5;       (* arm_MLS_VEC Q5 Q7 (Q3 :> LANE_H 0) 16 128 *)
  0x4f152739;       (* arm_SRSHR_VEC Q25 Q25 11 16 128 *)
  0x6f4342a0;       (* arm_MLS_VEC Q0 Q21 (Q3 :> LANE_H 0) 16 128 *)
  0x4f1524d5;       (* arm_SRSHR_VEC Q21 Q6 11 16 128 *)
  0x6f43433b;       (* arm_MLS_VEC Q27 Q25 (Q3 :> LANE_H 0) 16 128 *)
  0x6f4342bd;       (* arm_MLS_VEC Q29 Q21 (Q3 :> LANE_H 0) 16 128 *)
  0x4f1104b9;       (* arm_SSHR_VEC Q25 Q5 15 16 128 *)
  0x4f110410;       (* arm_SSHR_VEC Q16 Q0 15 16 128 *)
  0x4e391c7e;       (* arm_AND_VEC Q30 Q3 Q25 128 *)
  0x4f110659;       (* arm_SSHR_VEC Q25 Q18 15 16 128 *)
  0x4e301c75;       (* arm_AND_VEC Q21 Q3 Q16 128 *)
  0x4f11077f;       (* arm_SSHR_VEC Q31 Q27 15 16 128 *)
  0x4e391c79;       (* arm_AND_VEC Q25 Q3 Q25 128 *)
  0x4e3f1c61;       (* arm_AND_VEC Q1 Q3 Q31 128 *)
  0x4f1107a6;       (* arm_SSHR_VEC Q6 Q29 15 16 128 *)
  0x4e758415;       (* arm_ADD_VEC Q21 Q0 Q21 16 128 *)
  0x4e798659;       (* arm_ADD_VEC Q25 Q18 Q25 16 128 *)
  0x4e7e84a2;       (* arm_ADD_VEC Q2 Q5 Q30 16 128 *)
  0x4e261c66;       (* arm_AND_VEC Q6 Q3 Q6 128 *)
  0x3c9d0015;       (* arm_STR Q21 X0 (Immediate_Offset (word 18446744073709551568)) *)
  0x4e618775;       (* arm_ADD_VEC Q21 Q27 Q1 16 128 *)
  0x4e6687bb;       (* arm_ADD_VEC Q27 Q29 Q6 16 128 *)
  0x3c9f0002;       (* arm_STR Q2 X0 (Immediate_Offset (word 18446744073709551600)) *)
  0x3c9a0019;       (* arm_STR Q25 X0 (Immediate_Offset (word 18446744073709551520)) *)
...
let MLKEM_POLY_REDUCE_CORRECT = prove
 (`!a x pc.
        nonoverlapping (word pc,0x1a4) (a,512)
        ==> ensures arm
  ...
  ASM_REWRITE_TAC[WORD_ADD_0] THEN DISCARD_STATE_TAC "s274" THEN
