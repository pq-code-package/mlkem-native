...
- FIPS202:
  * Keccak-F1600 using lazy rotations (see [@HYBRID]): [keccak_f1600_x1_scalar.S](mlkem/keccak_f1600_x1_scalar.S)
...
The NTT and invNTT functions are super-optimized using [@SLOTHY].
