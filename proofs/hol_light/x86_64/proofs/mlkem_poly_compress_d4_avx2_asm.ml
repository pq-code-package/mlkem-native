...
let mlkem_poly_compress_d4_mc =
  define_assert_from_elf "mlkem_poly_compress_d4_mc" "x86_64/mlkem/mlkem_poly_compress_d4_avx2_asm.o"
(*** BYTECODE START ***)
[
...
let MLKEM_POLY_COMPRESS_D4_CORRECT = prove(
  ...
  (*** Symbolic execution ***)
  MAP_UNTIL_TARGET_PC (fun n -> X86_STEPS_TAC MLKEM_POLY_COMPRESS_D4_TMC_EXEC [n] THEN SIMD_SIMPLIFY_TAC
    ([compress_d4_avx2_alt]
     ...
     WORD_SUBWORD_8_0_16; BIT_15_ZX_8_16; MIN_ZX_8_16; WORD_VAL])) 1 THEN
