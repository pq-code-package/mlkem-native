...
let mlkem_poly_compress_d5_mc =
  define_assert_from_elf "mlkem_poly_compress_d5_mc" "x86_64/mlkem/mlkem_poly_compress_d5_avx2_asm.o"
(*** BYTECODE START ***)
[
...
let MLKEM_POLY_COMPRESS_D5_CORRECT = prove(
  ...
  MAP_UNTIL_TARGET_PC (fun n -> X86_STEPS_TAC MLKEM_POLY_COMPRESS_D5_TMC_EXEC [n] THEN SIMD_SIMPLIFY_TAC
    ([compress_d5_avx2_alt;
     ...
     ADD_ASSOC; GSYM (CONV_RULE NUM_REDUCE_CONV BYTES256_JOIN)])) 1 THEN
