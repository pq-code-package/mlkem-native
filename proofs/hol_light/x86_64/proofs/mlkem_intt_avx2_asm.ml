...
let mlkem_intt_mc = define_assert_from_elf "mlkem_intt_mc" "x86_64/mlkem/mlkem_intt_avx2_asm.o"
(*** BYTECODE START ***)
[
...
let MLKEM_INTT_CORRECT = prove
  ...
  MAP_UNTIL_TARGET_PC (fun n -> X86_STEPS_TAC MLKEM_INTT_TMC_EXEC [n] THEN
