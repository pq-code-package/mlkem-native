...
let LENGTH_SIMPLIFY_CONV =
  REWRITE_CONV[LENGTH_MLKEM_POLY_COMPRESS_D5_MC;
               LENGTH_MLKEM_POLY_COMPRESS_D5_TMC] THENC
  NUM_REDUCE_CONV THENC REWRITE_CONV[ADD_0];;

(* ------------------------------------------------------------------------- *)
(* compress_d5 computes round(32 * u / 3329)                                 *)
(* which equals (u * 32 + 1664) DIV 3329 for u in 0..3328.                   *)
(* This is Compress_5 from FIPS 203, Eq (4.7).                               *)
(* ------------------------------------------------------------------------- *)
