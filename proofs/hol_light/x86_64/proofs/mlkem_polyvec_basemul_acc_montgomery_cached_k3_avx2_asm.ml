...
let mlkem_basemul_k3_mc =
  define_assert_from_elf "mlkem_basemul_k3_mc" "x86_64/mlkem/mlkem_polyvec_basemul_acc_montgomery_cached_k3_avx2_asm.o"
(*** BYTECODE START ***)
[
...
let MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_POSTAMBLE_LENGTH = new_definition
  `MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_POSTAMBLE_LENGTH = 1`;;

let MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_CORE_END = new_definition
  `MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_CORE_END = LENGTH mlkem_basemul_k3_tmc - MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_POSTAMBLE_LENGTH`;;

let LENGTH_SIMPLIFY_CONV =
  REWRITE_CONV[LENGTH_MLKEM_BASEMUL_K3_TMC;
              MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_CORE_END;
              MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_POSTAMBLE_LENGTH] THENC
...
let MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_CORRECT = prove(
  `!src1 src2 src2t dst a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 pc.
        ...
        ==> ensures x86
              ...
              (\s. read RIP s = word (pc + MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_CORE_END) /\
                   ((!i. i < 16 ==> !j. j < 8
...
let MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_NOIBT_SUBROUTINE_CORRECT = prove(
  ...
  X86_PROMOTE_RETURN_NOSTACK_TAC mlkem_basemul_k3_tmc
    (CONV_RULE LENGTH_SIMPLIFY_CONV MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_CORRECT));;

(* NOTE: This must be kept in sync with the CBMC specification
 * in mlkem/src/native/x86_64/src/arith_native_x86_64.h *)

let MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_SUBROUTINE_CORRECT = prove(
  `!src1 src2 src2t dst a0 b0 c0 d0 dz0 a1 b1 c1 d1 dz1 a2 b2 c2 d2 dz2 pc stackpointer returnaddress.
        aligned 32 src1 /\
        aligned 32 src2 /\
        aligned 32 src2t /\
        ...
        ==> ensures x86
              ...
              (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
               MAYCHANGE [memory :> bytes(dst, 512)])`,
  MATCH_ACCEPT_TAC(ADD_IBT_RULE MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_NOIBT_SUBROUTINE_CORRECT));;
...
let full_spec,public_vars = mk_safety_spec
    ...
    MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_CORRECT
    mlkem_basemul_k3_tmc_EXEC;;

let MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_SAFE = time prove
 (`exists f_events.
       forall e src1 src2 src2t dst pc.
           ...
           ==> ensures x86
               (\s.
                    ...
                    read events s = e)
               (\s.
                    read RIP s = word (pc + MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_CORE_END) /\
                    (exists e2.
...
let MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_NOIBT_SUBROUTINE_SAFE = time prove
 (`exists f_events.
       forall e src1 src2 src2t dst pc stackpointer returnaddress.
          ...
          ==> ensures x86
               ...
               (\s s'. true)`,
  X86_PROMOTE_RETURN_NOSTACK_TAC mlkem_basemul_k3_tmc
    (CONV_RULE LENGTH_SIMPLIFY_CONV MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_SAFE) THEN
  DISCHARGE_SAFETY_PROPERTY_TAC);;

let MLKEM_POLYVEC_BASEMUL_ACC_MONTGOMERY_CACHED_K3_SUBROUTINE_SAFE = time prove
 (`exists f_events.
       forall e src1 src2 src2t dst pc stackpointer returnaddress.
          aligned 32 src1 /\
          aligned 32 src2 /\
