...
// exactly)
void poly_reduce_256bit(int16_t *r)
{
...
int test_poly_reduce_256bit_bounds(int16_t *test_values, int num_values,
...
{
  printf(
      "256-bit Vector poly_reduce test (matches actual ML-KEM "
      "implementation)\n");
  ...
  {
    printf("✓ All tests PASSED! 256-bit vector poly_reduce works correctly.\n");
    return 0;
  }
  else
  {
    printf("✗ %d test groups FAILED! 256-bit vector poly_reduce has issues.\n",
