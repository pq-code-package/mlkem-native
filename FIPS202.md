...
If your library has a <!---cite begin:@FIPS202-->[@FIPS202][^FIPS202]<!---cite end--> implementation, you can use it instead of the one shipped with mlkem-native.
